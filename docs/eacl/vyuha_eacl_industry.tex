...
RL red-teamer that beats state-of-the-art prompt-injection defenses. Our adaptive-attack ablation is a
black-box, search-based instance of this discipline; a learned RL attacker is stronger than ours and a
natural stress test (see Limitations). HASTE \citep{haste} proactively hardens detectors by generating
...
system} rather than to one component in isolation.
...
Crescendo result is on modeled score trajectories. Our adaptive attacker is an exhaustive search over
public transforms; a learned RL red-teamer such as PISmith \citep{pismith} is stronger, and a direct
head-to-head is future work. Some efficiency and attack-cost figures are
...
\bibitem[PISmith(2026)]{pismith} PISmith: Reinforcement Learning-based Red Teaming for Prompt Injection Defenses. 2026. \emph{arXiv:2603.13026}.
