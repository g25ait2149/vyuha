...
search, which the augmented detector also survives at the reported operating point; a \emph{learned}
RL red-teamer such as PISmith \citep{pismith} optimises against the model rather than composing fixed
transforms and is stronger still, so a direct head-to-head remains future work. Some efficiency and attack-cost figures are
